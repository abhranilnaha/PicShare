...

{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// System.out.println("getFriendsData onCompleted : jsonArray " +
		// jsonArray);
		// System.out.println("getFriendsData onCompleted : response " +
		// response);
		// try {
		// JSONObject jsonObject = response.getJSONObject();
		// System.out.println("getFriendsData onCompleted : jsonObject " +
		// jsonObject);
		// JSONObject summary = jsonObject.getJSONObject("summary");
		// System.out.println("getFriendsData onCompleted : summary total_count - "
		// + summary.getString("total_count"));
		// } catch (Exception e) {
		// e.printStackTrace();
		// }
		// }
		...
		// GraphRequest.newMyFriendsRequest(accessToken,new
		...
		// intent.putStringArrayListExtra("test", (ArrayList<String>)
		// friendList);
