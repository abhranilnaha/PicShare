...
public class SendInviteAcitvity extends Activity {
	 ...
	 * super.onCreate(savedInstanceState); setContentView(R.layout.friend_list);
	 * System.out.println("Inside FriendsListAcitvity");
	 * LoginManager.getInstance
	 * ().logInWithReadPermissions(this,Arrays.asList("user_friends"));
	 * LoginManager
	 * .getInstance().logInWithReadPermissions(this,Arrays.asList("user_about_me"
	 * ));
	 * LoginManager.getInstance().logInWithReadPermissions(this,Arrays.asList
	 * ("read_friendlists"));
	 * LoginManager.getInstance().logInWithReadPermissions
	 * (this,Arrays.asList("read_custom_friendlists"));
	 * 
	 * 
	 * AccessToken accessToken = AccessToken.getCurrentAccessToken(); //
	 * GraphRequest request = GraphRequest.newMeRequest(accessToken, // new
	 * GraphRequest.GraphJSONObjectCallback() { // @Override // public void
	 * onCompleted(JSONObject object,GraphResponse response) // { // //
	 * Application code // try // { //
	 * System.out.println("Inside FriendsListAcitvity... calling Graph API"); //
	 * String name = (String) object.get("name"); // String id = (String)
	 * object.get("id"); // Toast.makeText(getApplicationContext(),
	 ...
	 * 
	 * 
	 * //JSONArray data = innerJson.getJSONArray(""); // Object objname =
	 * (Object) object.get("friendlists"); //
	 * System.out.println("objname is :"+objname); //String id = (String)
	 * object.get("id"); //Toast.makeText(getApplicationContext(),
	 * "name is "+name, Toast.LENGTH_SHORT).show();
	 * //Toast.makeText(getApplicationContext(), "", Toast.LENGTH_SHORT); }
	 * catch (Exception e) {
	 * 
	 * e.printStackTrace(); } } }); Bundle parameters = new Bundle();
	 * parameters.putString("fields", "friend-list");
	 * request.setParameters(parameters); request.executeAsync();
	 * 
	 * /* new GraphRequest( accessToken,"/{friend-list-id}",null,HttpMethod.GET,
	 * new GraphRequest.Callback() { public void onCompleted(GraphResponse
	 * response) { Toast.makeText(getApplicationContext(), "Viewing friends!! ",
	 * Toast.LENGTH_SHORT).show();
	 * 
	 * // try // {
	 * 
	 * JSONObject innerJson = response.getJSONObject(); JSONArray j;
	 * 
	 * 
	 ...
	 * 
	 * // String id = (String)obj.get("id"); // String name =
	 * (String)obj.get("name"); // System.out.println("friendlist id is :"+id);
	 * // System.out.println("friendlist name is :"+name); //} // } // catch
