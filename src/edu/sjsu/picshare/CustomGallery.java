		...
		UploadToAlbum.setOnClickListener(new View.OnClickListener() {
			public void onClick(View view) {
				...
				for (int i = 0; i < selectedItems.size(); i++) {
					...
					bm.compress(Bitmap.CompressFormat.JPEG, 100, baos); // bm is
																		// the
																		// bitmap
																		// object
					...
					ParseFile file = new ParseFile("androidbegin.png",
							byteArrayImage);
					...
					Toast.makeText(CustomGallery.this,
							i + 1 + " Image Uploaded", Toast.LENGTH_SHORT)
							.show();
				}
